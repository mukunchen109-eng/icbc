...
public final class ReviewQueryModels {
 ...
 public record AdminReviewReportSummary(Long id,String reportTitle,String status,Long currentReviewerId,String currentReviewer,String updatedAt){}
 ...
 public record ReviewRecordView(Long id,Long articleId,Integer sequenceNo,Long operatorId,String operatorUsername,String actionType,String selectedText,String reason,String commentText,String createdAt){}
}
