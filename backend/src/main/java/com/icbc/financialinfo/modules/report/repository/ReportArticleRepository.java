...
public class ReportArticleRepository {
  ...
  public void insertArticles(
    long reportId,
    List<DifySummaryArticle> articles,
    ...
    try {
      log.debug(
        "准备写入 report_article: table={}, reportId={}, articleCount={}, createdAt={}",
        tableName,
        reportId,
        articles.size(),
        createdAt
      ...
      log.debug(
        "写入 report_article 成功: table={}, reportId={}, articleCount={}",
        tableName,
        reportId,
        articles.size()
      );
      ...
      log.error(
        "写入 report_article 失败: table={}, reportId={}, articleCount={}, createdAt={}, exceptionType={}, message={}",
        tableName,
        reportId,
        articles.size(),
        createdAt,
      ...
      log.error(
        "写入 report_article 发生未预期异常: table={}, reportId={}, articleCount={}, createdAt={}, exceptionType={}, message={}",
        tableName,
        reportId,
        articles.size(),
        createdAt,
