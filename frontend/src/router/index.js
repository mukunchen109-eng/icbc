...
const routes = [{ path: '/login', component: () => import('../views/LoginView.vue') }, { path: '/review-workbench', component: () => import('../views/ReviewWorkbenchView.vue') }, { path: '/', component: MainLayout, children: [
...
router.beforeEach(to => {
  ...
  if (to.path === '/login') return isReviewUser(user) ? '/review-workbench' : '/dashboard'
  if (isReviewUser(user) && to.path !== '/review-workbench') return '/review-workbench'
